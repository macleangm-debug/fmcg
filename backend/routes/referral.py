...
async def get_my_referral_info(current_user: dict = Depends(get_current_user)):
    ...
    base_url = os.environ.get("FRONTEND_URL", "https://product-theme-ui.preview.emergentagent.com")
...
async def send_referral_invite(
    ...
    if EMAIL_SERVICE_AVAILABLE:
        base_url = os.environ.get("FRONTEND_URL", os.environ.get("API_BASE_URL", "https://product-theme-ui.preview.emergentagent.com"))
        referral_link = f"{base_url}/signup?ref={referral_code}"

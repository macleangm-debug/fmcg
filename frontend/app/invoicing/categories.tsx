...
const styles = StyleSheet.create({
  ...
  emptyText: { fontSize: 16, color: THEME.gray, marginTop: 12 },
  ...
  categorySearchInput: { flex: 1, fontSize: 15, color: '#111827', padding: 0, outlineStyle: 'none' },
  ...
  inlineInput: { backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E5E7EB', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12, fontSize: 15, color: '#111827', marginBottom: 10, outlineStyle: 'none' },

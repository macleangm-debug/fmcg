...
console.log('BulkProductImportModal imported:', typeof BulkProductImportModal);
...
const styles = StyleSheet.create({
  ...
  // Customer First Flow Styles - Clean Design
  ...
  customerFirstIconInner: {
    position: 'relative',
  },
  customerFirstIconBadge: {
    position: 'absolute',
    top: -4,
    left: -4,
    width: 18,
